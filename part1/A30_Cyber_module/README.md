...
The module included topics such as -

1) Understanding cyber security and common threats
2) Phishing and social engineering attacks
3) password security and authentication methods
4) data protection and safe internet practices 
5) incident response and cyber awareness culture
